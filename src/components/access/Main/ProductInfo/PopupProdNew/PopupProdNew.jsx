...
const PopUpProdNew = ({ popUpProdNew, setPopUpProdNew, mainData, setSuccessInfo, setIsOpenSc }) => {
	...
	const validateForm = () => {
		...
		if (
			formattedSum > 5000000 ||
			formattedSum < mainData.minPrice ||
			formattedSum > mainData.maxPrice
		) {
			newErrors.rangeError =
				"Введенная сумма превышает максимально допустимую. Пожалуйста, введите сумму, которая не больше $ 5 000 000";
		}
								...
								<div className="confirm">
									<label className="confirmLabel">
										<span
											...
											style={
												isChecked || !errors.checkboxError ? {} : { color: "#FF0000" }
											}
										>
											Я подтверждаю, что ознакомлен(а) с условиями и соглашением о
											предоставлении услуг, а также с рисками, связанными с инвестициями
											в активы, и согласен(согласна) с ними.
										</span>
										<input
											type="checkbox"
											name="confirm"
